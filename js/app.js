...
selected.addEventListener("click", selectedItems);
        ...
        .then((data) => {
            ...
            getData.forEach((item, key) => {
                ...
                for (let i = 0; i < itemNameEdit.length; i++) {
                    itemNameEdit[i] =
                        itemNameEdit[i].charAt(0).toUpperCase() +
                        itemNameEdit[i].slice(1).toLowerCase().replace(/\s+/g, " ");
                }
